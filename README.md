...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/azure-mgmt-resource-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/azure-mgmt-resource-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `azure-mgmt-resource` can be installed with `conda`:
...
```
mamba install azure-mgmt-resource
```

It is possible to list all of the versions of `azure-mgmt-resource` available on your platform with `conda`:
...
```
mamba search azure-mgmt-resource --channel conda-forge
```
...
mamba repoquery search azure-mgmt-resource --channel conda-forge

# List packages depending on `azure-mgmt-resource`:
mamba repoquery whoneeds azure-mgmt-resource --channel conda-forge

# List dependencies of `azure-mgmt-resource`:
mamba repoquery depends azure-mgmt-resource --channel conda-forge
```
